...
# Arguments
- `line::array`:The lines of interest.
- `sample::array`: The samples of interest.
- `burst_number::Int`: The number of the burst of interest.
- `meta::Dict`:  Meta information from the Sentinel-1 SLC image
- `precise_orbit:Dict`: Precise orbit data
...
```
"""
function deramp(line,sample,burst_number, meta, precise_orbit)
    ...
    tau = tau_0 .+ (sample .-1) .* Delta_tau_s # Slant range time of ith sample, Eqn. 12
